...
<html lang="en">
  <head>
    ...
    <title>TOKO SEMBAKO 08TPLE007</title>
      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="assets/images/logo1.jpeg" class="w-100" alt="" />
            </div>
            <div class="col-md-6">
              <h1 style="font-weight: bold; margin-bottom: 15px;">TOKO SEMBAKUY 08TPLE007 - Kelompok 1 ONLINE</h1>
              <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
                Kami adalah penjual utama Anda untuk semua kebutuhan SEMBAKO secara online. Berbagai produk berkualitas dan layanan yang ramah, kami berkomitmen untuk menyediakan bahan terbaik dan terlengkap juga sempurna untuk segala keperluan dapur Kamu. iya Kamu, ehe.
              </p>

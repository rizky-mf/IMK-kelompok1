        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">Sembakuy</h1>
              <h5 class="">Toko Sembako Berkualitas Tinggi</h5>
              <a
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">Sembakuy TPLE007</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>Selamat datang di Toko Sembako TPLE007
              Kami adalah tujuan utama Anda untuk semua kebutuhan pangan. Dengan bangga melayani pelanggan di seluruh lokasi, menyediakan produk atau barang pangan berkualitas tinggi dan pelayanan yang unggul. 
           </p>
            </div>
          </div>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-6">
                <h5>Visi</h5>
                <p>Menjadi sumber terdepan untuk kebutuhan pangan, berkualitas tinggi, dan berkelanjutan, yang membantu meningkatkan kemudahan dan efisiensi dalam berbelanja kami.</p>
            </div>
            <div class="col-md-6">
                <h5>Misi</h5>
                <p>Pelayanan Pelanggan Terbaik, Kami percaya bahwa pelayanan pelanggan adalah kunci kesuksesan. Kami akan selalu berusaha keras untuk memahami kebutuhan pelanggan kami dan memberikan solusi terbaik.</p>
            </div>
          </div>
        </div>
      </section>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
              &copy; 2024 Copyright by Kelompok-1. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
